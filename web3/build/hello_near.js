...
let HelloNear = (_dec = NearBindgen({
  requireInit: true
}), _dec2 = initialize(), _dec3 = view(), _dec4 = call({}), _dec5 = call({}), _dec(_class = (_class2 = class HelloNear {
  // diagnosis: UnorderedMap<> = new UnorderedMap([['', ['']]]);
  diagnosis = new UnorderedMap("as");
  init() {
    // this.diagnosis = new UnorderedMap([[ near.predecessorAccountId(), ['hi yanzi']]]);
    this.diagnosis.set(predecessorAccountId(), ["name", "desc"]);
  }
  ...
  // on every login, check if id exists, if not then add to map using set
  add_user({
    id
  }) {
...
}, (_applyDecoratedDescriptor(_class2.prototype, "init", [_dec2], Object.getOwnPropertyDescriptor(_class2.prototype, "init"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "get_diagnosis", [_dec3], Object.getOwnPropertyDescriptor(_class2.prototype, "get_diagnosis"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "add_diagnosis", [_dec4], Object.getOwnPropertyDescriptor(_class2.prototype, "add_diagnosis"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "add_user", [_dec5], Object.getOwnPropertyDescriptor(_class2.prototype, "add_user"), _class2.prototype)), _class2)) || _class);
function add_user() {
...
function add_diagnosis() {
  ...
  const _args = HelloNear._getArgs();
  const _result = _contract.add_diagnosis(_args);
  HelloNear._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(HelloNear._serialize(_result, true));
}
function get_diagnosis() {
  ...
  const _args = HelloNear._getArgs();
  const _result = _contract.get_diagnosis(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(HelloNear._serialize(_result, true));
}
function init() {
  const _state = HelloNear._getState();
...
export { add_diagnosis, add_user, get_diagnosis, init };
